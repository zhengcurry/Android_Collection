...
public class ClearEditText extends AppCompatEditText implements OnFocusChangeListener,
    ...
    private ClickCancelAreaListener clickCancelAreaListener;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (getCompoundDrawables()[2] != null) {
            if (event.getAction() == MotionEvent.ACTION_UP) {
                ...
                if (touchable) {
                    this.setText("");
//                    clickCancelAreaListener.clickCancel();
                }
            }
        }
    ...
    public void setClickCancelAreaListener(ClickCancelAreaListener listener) {
        this.clickCancelAreaListener = listener;
    }

    public interface ClickCancelAreaListener {
        void clickCancel();
    }
}
