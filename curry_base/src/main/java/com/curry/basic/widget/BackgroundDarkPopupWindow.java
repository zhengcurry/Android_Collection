...
public class BackgroundDarkPopupWindow extends PopupWindow {
     ...
     * @return
     */
    public static BackgroundDarkPopupWindow setPopupWindow(View popupView, View view) {
        final BackgroundDarkPopupWindow mPopupWindow = new BackgroundDarkPopupWindow(popupView,
        ...
        mPopupWindow.setBackgroundDrawable(new BitmapDrawable(popupView.getContext().getResources(), (Bitmap) null));
        mPopupWindow.setAnimationStyle(android.R.style.Animation_Dialog);
        mPopupWindow.showAsDropDown(view, 0, -8);
        return mPopupWindow;
    }

    public static BackgroundDarkPopupWindow setPopupWindow1(View popupView, View view) {
        final BackgroundDarkPopupWindow mPopupWindow = new BackgroundDarkPopupWindow(popupView,
                WindowManager.LayoutParams.WRAP_CONTENT,
                WindowManager.LayoutParams.WRAP_CONTENT);
        mPopupWindow.setDarkStyle(-1);
...
//        mPopupWindow.darkBelow(view);
        ...
        mPopupWindow.setBackgroundDrawable(new BitmapDrawable(popupView.getContext().getResources(), (Bitmap) null));
        mPopupWindow.setAnimationStyle(android.R.style.Animation_Dialog);
        mPopupWindow.showAsDropDown(view, -240, 14);
        return mPopupWindow;
    }
}
